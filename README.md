...
## Known Limitations
- Test set annotations generated by GPT-4o-mini, the same model used 
  as benchmark baseline. This introduces circular evaluation bias — 
  GPT-4o-mini may score artificially high by agreeing with its own 
  annotation style rather than ground truth.
- Mitigation planned: manual golden set of 50 examples if benchmark 
  results appear inflated.